  ...
  new Strategy(
    {
      ...
      authorizationURL:
        "https://dev-84113371.okta.com/oauth2/default/v1/authorize",
      ...
      callbackURL:
        "https://t4yzeb-3000.preview.csb.app/authorization-code/callback",
...
app.use(
  ...
  (req, res) => {
    ...
    res.redirect(
      "http://localhost:4502/content/anthemeap/us/en/auth.html?wcmmode=disabled"
    );
  }
);
